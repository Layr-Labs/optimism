...
var hokuleaHostPath string

func init() {
	hokuleaHostPath = os.Getenv("HOKULEA_HOST_PATH")
}

func IsEigenDAConfigured() bool {
	return hokuleaHostPath != ""
}

func RunHokuleaNative(
	t helpers.Testing,
	workDir string,
	...
	hostCmd, err = vm.NewNativeHokuleaExecutor().OracleCommand(vmCfg, workDir, inputs)
